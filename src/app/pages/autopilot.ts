  ...
  template: `
    <div class="relative overflow-hidden">
      ...
      <section class="container mx-auto px-6 pt-16 md:pt-24 pb-10 text-center">
        ...
        >
          Deep Variance <span class="text-primary">Autopilot</span>.
        </h1>
        ...
        >
          <div class="bg-white px-8 py-6 text-center">
            <p class="text-4xl font-header font-bold text-dark tracking-tight mb-1">7</p>
            <p class="text-xs text-slate-500 font-medium uppercase tracking-widest">Automated pipeline stages</p>
          </div>
          <div class="bg-white px-8 py-6 text-center">
            <p class="text-4xl font-header font-bold text-dark tracking-tight mb-1">1 Call</p>
            <p class="text-xs text-slate-500 font-medium uppercase tracking-widest">From raw data to trained model</p>
          </div>
          <div class="bg-white px-8 py-6 text-center">
            <p class="text-4xl font-header font-bold text-dark tracking-tight mb-1">8+</p>
            <p class="text-xs text-slate-500 font-medium uppercase tracking-widest">Model architectures ranked</p>
          </div>
        </div>
      </section>
...
export class AutopilotPageComponent {
  ...
  constructor() {
    this.title.setTitle('Autopilot | Deep Variance');
    this.meta.updateTag({ name: 'description', content: 'The end-to-end AutoML pipeline. Automatically infer types, clean data, engineer features, and train the best-fit ML or deep learning model. Powered by LLM-driven code generation and intelligent multi-model comparison.' });
    this.meta.updateTag({ property: 'og:title', content: 'Autopilot | Deep Variance' });
    this.meta.updateTag({ property: 'og:description', content: 'The end-to-end AutoML pipeline. Automatically infer types, clean data, engineer features, and train the best-fit ML or deep learning model. Powered by LLM-driven code generation and intelligent multi-model comparison.' });
    this.meta.updateTag({ property: 'og:url', content: 'https://deepvariance.com/autopilot' });
    this.meta.updateTag({ name: 'twitter:title', content: 'Autopilot | Deep Variance' });
    this.meta.updateTag({ name: 'twitter:description', content: 'The end-to-end AutoML pipeline. Automatically infer types, clean data, engineer features, and train the best-fit ML or deep learning model. Powered by LLM-driven code generation and intelligent multi-model comparison.' });
    this.setCanonical('https://deepvariance.com/autopilot');
  }
    ...
    try {
      const res = await fetch('https://formsubmit.co/ajax/founders@deepvariance.com', {
        ...
        body: JSON.stringify({
          ...
          email,
          organization: org,
          _subject: 'Deep Variance: Demo Request (Autopilot)',
          _captcha: 'false',
        }),
      });
