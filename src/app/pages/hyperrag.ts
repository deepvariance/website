          ...
          <div class="max-w-4xl mx-auto">
            <div class="text-center mb-12">
              <h2
                class="text-3xl md:text-4xl font-header font-bold text-dark tracking-tight mb-4"
              >
                Benchmarked on 4x A100-SXM4-40GB
              </h2>
              <p class="text-slate-500 max-w-xl mx-auto font-medium">
                1,000 queries from MS-MARCO v2.1 with Zipfian access pattern
                (alpha 1.1). Top 3% of documents receive 60% of requests.
              </p>
            </div>
              ...
              <table class="w-full text-sm">
                <thead>
                  <tr class="border-b border-slate-100">
                    <th
                      class="text-left px-6 py-4 text-xs font-extrabold text-slate-400 uppercase tracking-widest"
                    >
                      Paradigm
                    </th>
                    <th
                      class="text-right px-6 py-4 text-xs font-extrabold text-slate-400 uppercase tracking-widest"
                    >
                      Baseline TTFT
                    </th>
                    <th
                  ...
                  @for (row of benchmarkRows; track row.paradigm; let last = $last) {
                    <tr [class.border-b]="!last" class="border-slate-50">
                      <td class="px-6 py-4">
                        ...
                        <div class="text-xs text-slate-400 font-medium">{{ row.model }}</div>
                      </td>
            ...
            <p class="text-center text-xs text-slate-400 mt-4 font-medium">
              Calibrated roofline cost model with measured A100-SXM4-40GB
              hardware profile. BF16 TFLOPS: 211 measured / 312 theoretical.
              HBM bandwidth: 1,378 GB/s measured / 1,555 GB/s theoretical.
            </p>
          </div>
        </div>
      </section>
