...
export const MODULES: ModuleDef[] = [
  {
    ...
    status: 'Live',
    tagline: 'Fit a 70B model on a single H100 instead of splitting it across two.',
    metric: '+65%',
    metricLabel: 'more usable VRAM per card, measured against the default PyTorch allocator',
...

  {
    ...
    status: 'Beta',
    tagline: 'Cut first-token latency from 480ms to 80ms on repeat RAG context.',
    metric: '6x',
    metricLabel: 'faster first token when retrieved context overlaps across requests',
...

  {
    ...
    status: 'Early',
    tagline: 'Serve the same QPS on half the power budget.',
    metric: '\u221250%',
    metricLabel: 'lower energy per token on H100 attention and GEMM kernels',
